...
PROTOCOL_PRIMARY_NAME = "issue627-shared-cash-prereg-v3-primary"
...
PROTOCOL_FRESH_NAME = "issue627-shared-cash-prereg-v3-fresh"
...
def authority_check(*, result_slot: str) -> None:
    ...
    for args in (
        (PROTOCOL_PRIMARY_ID, "issue627-shared-cash-prereg-v3-primary", PROTOCOL_PRIMARY_API_DIGEST, PROTOCOL_SEAL_RUN),
        (PROTOCOL_FRESH_ID, "issue627-shared-cash-prereg-v3-fresh", PROTOCOL_FRESH_API_DIGEST, PROTOCOL_SEAL_RUN),
