"""Result-blind global activation contract for Issue #645 directional execution."""
...
SCHEMA_VERSION = "issue645_directional_activation_v1"
ISSUE_NUMBER = 645
ACTIVATION_ARTIFACT_NAME = "issue645-corrected-directional-activation-v1"
...
def build_activation_claim(
    ...
    *,
    ...
    """Build the only pre-economic activation claim for the frozen Issue #645 run."""
