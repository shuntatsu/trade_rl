...
- [`specs/2026-09-12-execution-economics-build-contract.md`](specs/2026-09-12-execution-economics-build-contract.md) — #481のbuild-level execution economics authorityとCanonical M2 v2 compatibility contract

現在Activeなplan:

- [`plans/2026-09-12-execution-economics-build-contract.md`](plans/2026-09-12-execution-economics-build-contract.md) — 上記contractをTDDで実装し、real-cost-assumption Canonical M2を再bootstrapして検証する計画
