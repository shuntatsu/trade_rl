...
- [`architecture/research-assurance.md`](architecture/research-assurance.md) — research thesis、mechanism、evidence sufficiency、claim boundaryをeconomic execution前に独立reviewする恒久契約
...
- research thesis、mechanism、evidence sufficiency、decision/claim boundaryを変えた → `architecture/research-assurance.md` とexact Research Assurance Record / review authority
