...
現在Activeな設計は [`specs/2026-09-11-agent-repository-control-plane-v1-design.md`](specs/2026-09-11-agent-repository-control-plane-v1-design.md) である。実装計画は責務と検証境界を混ぜないため、次の3つに分割する。
