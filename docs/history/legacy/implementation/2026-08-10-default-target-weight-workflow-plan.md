...
- Produces: One reviewable PR based on the telemetry-semantics branch until that dependency lands on `main`, with exact-head test evidence and no mutation of the active generation.
...
- [ ] **Step 4: Keep the pull request Draft and run exact-head CI**
