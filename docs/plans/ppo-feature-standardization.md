# PPO feature standardization implementation

Status: Active

Specification: [ppo-feature-standardization.md](../specs/ppo-feature-standardization.md).

- [x] Audit feature scales and confirm isolation from active risk-only runs.
...
Work in the separate local normalization worktree. Keep one durable remote branch
per active write task and integrate through the normal exact-head PR gate.
