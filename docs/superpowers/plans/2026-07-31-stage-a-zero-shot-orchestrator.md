...
**Files:**
- Create: `trade_rl/workflows/stage_a_zero_shot_runner_contracts.py`
- Test: `tests/workflows/test_stage_a_zero_shot_runner_contracts.py`
...
**Files:**
- Create: `trade_rl/workflows/stage_a_zero_shot_runner.py`
- Test: `tests/workflows/test_stage_a_zero_shot_runner.py`
...
**Files:**
- Create: `trade_rl/workflows/stage_a_zero_shot_artifacts.py`
- Test: `tests/workflows/test_stage_a_zero_shot_artifacts.py`
