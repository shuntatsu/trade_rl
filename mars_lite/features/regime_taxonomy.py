...
FINE_REGIMES = (
    "trend_up_early", "trend_up_mature",
    "trend_down_early", "trend_down_mature",
    "range_lowvol", "range_highvol",
)
...
def label_fine_regimes(
    ...
    direction = np.where(trend > trend_threshold, 1,
                         np.where(trend < -trend_threshold, -1, 0))
