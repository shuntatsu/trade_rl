...
path = ROOT / "trade_rl/rl/normalization.py"
text = path.read_text(encoding="utf-8")
old = '''        if (self.absolute_train_start is None) != (self.absolute_train_end is None):
...
'''
new = '''        absolute_start = self.absolute_train_start
