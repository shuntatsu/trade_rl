"""CLI for Causal Alpha V9 nonlinear-wave research."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Causal Alpha V9 research")
    for name in (
        "config",
        "run-config",
        "runtime-manifest",
    ...
    try:
        evidence = run_causal_alpha_v9_selection(
