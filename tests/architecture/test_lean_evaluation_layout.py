...
def test_evaluation_responsibility_packages_exist() -> None:
    required = (
        ...
        "experiments/bootstrap/__init__.py",
        "experiments/bootstrap/config.py",
        "experiments/bootstrap/binance.py",
        "experiments/bootstrap/workflow.py",
        "experiments/bootstrap/cli.py",
