...
class C3ReportingFixtures:
    def valid_summary_payload(self) -> dict[str, object]:
        folds = [
            {
                "effective_days": 30,
                "failure_reasons": [],
    ...
    def refreshed(self, payload: dict[str, object]) -> dict[str, object]:
...
@pytest.fixture
def c3_reporting() -> C3ReportingFixtures:
    return C3ReportingFixtures()
