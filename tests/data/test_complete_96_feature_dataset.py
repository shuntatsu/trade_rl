...
def test_complete_preset_builds_226_role_specific_causal_features() -> None:
    ...
    assert dataset.features.shape == (1_441, 1, 226)
    ...
    assert dataset.feature_names[-1] == "1d__cross_asset_dispersion_1bar"
