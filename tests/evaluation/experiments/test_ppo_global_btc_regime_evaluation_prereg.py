...
def test_protocol_rejects_any_authority_or_decision_rule_drift() -> None:
    ...
    mutations: tuple[dict[str, object], ...] = (
        ...
        {"factor_prereg_seal_run_id": 0},
        {"factor_prereg_seal_artifact_id": 0},
        {"factor_prereg_seal_artifact_digest": "sha256:" + "0" * 64},
        {"factor_prereg_fresh_artifact_id": 0},
        {"factor_prereg_fresh_artifact_digest": "sha256:" + "0" * 64},
        {"implementation_head": "0" * 40},
        {"implementation_tree": "0" * 40},
        {"implementation_index_digest": "0" * 64},
        {"implementation_seal_run_id": 0},
        {"implementation_seal_artifact_id": 0},
        {"implementation_seal_artifact_digest": "sha256:" + "0" * 64},
        {"implementation_fresh_artifact_id": 0},
        {"implementation_fresh_artifact_digest": "sha256:" + "0" * 64},
        ...
        {"comparison_schema": "controlled_evidence_comparison_v1"},
        {"ppo_seeds": (0, 1, 2, 3, 4, 5)},
        {"ppo_total_timesteps": 200_000},
        {"n_bootstrap": 10_000},
        {"bootstrap_seed": 0},
        {"factor_effect_statistic": "mean_excess_total_return"},
        {"candidate_return_statistic": "mean_candidate_total_return"},
        {"seed_robustness_statistic": "aggregate_seed_mean"},
        ...
        {"no_post_result_threshold_change": False},
        {"no_post_result_metric_substitution": False},
