...
def test_emit_exact_a4_runner_patch_material() -> None:
    pipeline_path = (
        ROOT / "examples" / "binance-multitimeframe" / "full_research_pipeline.py"
    )
    ...
    tests_path = (
        ROOT / "tests" / "examples" / "test_binance_multitimeframe_full_assets.py"
    )
