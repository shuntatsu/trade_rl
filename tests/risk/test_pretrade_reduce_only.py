...
def test_reduce_only_micro_reduction_is_applied() -> None:
    ...
    np.testing.assert_allclose(result.weights, np.array([0.1000]))
    assert "reduce_only" in result.reasons
...
def test_reduce_only_still_obeys_max_turnover() -> None:
