...
def strategy() -> MeanReversionIntentStrategy:
...
def test_flat_position_fades_large_deviation() -> None:
    model = strategy()
...
def test_existing_position_holds_exits_and_reverses_symmetrically() -> None:
    model = strategy()
