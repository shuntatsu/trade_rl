...
from mars_lite.utils.metrics import deflated_sharpe_ratio, _norm_cdf, _norm_ppf
...
class TestDeflatedSharpeRatio:
    ...
    def test_more_trials_lowers_dsr(self):
        ...
        few = deflated_sharpe_ratio(rets, trial_sharpes=[1.5], annualization_factor=24 * 365)
        many = deflated_sharpe_ratio(
            rets, trial_sharpes=list(rng.normal(0, 1.5, 200)),
