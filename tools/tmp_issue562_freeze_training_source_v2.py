...
SOURCE_IMPLEMENTATION_HEAD = "9092c8360d6625c97700de5342ba0e0cbec1d1a0"
CALIBRATION_HEAD = "9268e31d5ec261d6463bb4e9611804e4c7184def"
FULL_CI_RUN_ID = 34859669128
FULL_CI_GUIDE_ARTIFACT_ID = 10354901670
FULL_CI_GUIDE_ARTIFACT_DIGEST = (
    "sha256:6a4657b76955ee695579c86e903c0033fa9ea191fa8a096c963ac0e02ab0e3d5"
)
...
def _inspect_archive(
    *, symbol: str, period: str, zip_path: Path, checksum_path: Path
    ...
    if not fields or fields[0].lower() != zip_sha256:
...
def main() -> None:
    ...
    body: dict[str, object] = {
        "schema_version": "signed_taker_flow_training_source_bundle_v2",
        "issue_number": 562,
        ...
        "exact_head_guide_artifact_id": FULL_CI_GUIDE_ARTIFACT_ID,
        "exact_head_guide_artifact_api_digest": FULL_CI_GUIDE_ARTIFACT_DIGEST,
        ...
        "native_gap_policy": "preserve official gaps; no imputation/source substitution; sparse-safe source plus builder regular clock marks missing rows unavailable",
    ...
    (output_root / "source-manifest.json").write_bytes(canonical_json_bytes(manifest))
    print(
        json.dumps(
            {
