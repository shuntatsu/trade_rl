...
class MarketDatasetBuilder:
    ...
    def build(
        ...
        global_age_hours = global_age_hours.astype(np.float32)
        ...
        return MarketDataset(
            ...
            global_feature_staleness_hours=global_age_hours,
