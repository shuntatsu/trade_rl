...
def execution_cost_for_overlay(execution_overlay: str) -> ExecutionCostConfig:
    """Resolve the single maintained execution-cost overlay contract."""
...
def _execution_cost_for_overlay(execution_overlay: str) -> ExecutionCostConfig:
    """Backward-compatible private owner alias."""

    return execution_cost_for_overlay(execution_overlay)
