"""Deterministic initial mutable state for ``ResidualMarketEnv``."""
...
class EnvironmentInitialStateFactory:
    """Create fresh invocation-local mutable values for one environment."""
    ...
    def create(request: EnvironmentInitialStateRequest) -> EnvironmentInitialState:
        ...
        return EnvironmentInitialState(
            ...
            episode_seed=config.execution_cost.random_seed,
