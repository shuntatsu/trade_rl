...
def combine_lagrangian_advantages(
    *,
    ...
    """Compose raw advantages and optionally normalize only the final vector.

    ``normalize_reward`` is a compatibility alias from the first PR C draft.
    It now controls final-combined normalization; reward and cost columns are
    never normalized separately.
    """
