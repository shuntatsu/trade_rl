"""Lean single-signal trend intent strategy."""
...
class TrendIntentConfig:
    """Hysteresis thresholds for one causal trend feature."""
...
class TrendIntentStrategy:
    """Map one causal trend feature to LONG/FLAT/SHORT intent with hysteresis."""

    def __init__(self, config: TrendIntentConfig) -> None:
        self.config = config
...
__all__ = ["TrendIntentConfig", "TrendIntentStrategy"]
